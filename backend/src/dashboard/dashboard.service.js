...
var DashboardService = function () {
    ...
    var DashboardService = _classThis = /** @class */ (function () {
        function DashboardService_1(tenantsRepository, invoicesRepository, patientsRepository, auditService) {
        ...
        DashboardService_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                var totalTenants, activeTenants, totalPatients, revenueResult, totalRevenue;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.tenantsRepository.count()];
                        case 1:
                            totalTenants = _a.sent();
                            return [4 /*yield*/, this.tenantsRepository.count({ where: { status: tenant_entity_1.TenantStatus.Active } })];
                        case 2:
                            activeTenants = _a.sent();
                            return [4 /*yield*/, this.patientsRepository.count()];
                        case 3:
                            totalPatients = _a.sent();
                            return [4 /*yield*/, this.invoicesRepository
                        ...
                        case 4:
                            ...
                            return [2 /*return*/, { totalTenants: totalTenants, activeTenants: activeTenants, totalPatients: totalPatients, totalRevenue: totalRevenue }];
                    }
                });
            });
        };
        DashboardService_1.prototype.getRecentActivity = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.auditService.findRecent(10)];
                });
            });
        };
