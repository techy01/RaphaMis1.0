...
var communication_message_entity_1 = require("./communication-message.entity");
var communication_service_1 = require("./communication.service");
var communication_controller_1 = require("./communication.controller");
var CommunicationModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([communication_message_entity_1.CommunicationMessage])],
