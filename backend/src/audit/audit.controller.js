...
var AuditController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(user_entity_1.UserRoleEnum.Superadmin, user_entity_1.UserRoleEnum.Admin), (0, common_1.Controller)('audit-logs')];
    ...
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.findAll = function (limit) {
            var parsedLimit = limit ? parseInt(limit, 10) : 50;
