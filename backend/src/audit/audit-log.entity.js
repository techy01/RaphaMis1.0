...
var AuditLog = function () {
    ...
    var AuditLog = _classThis = /** @class */ (function () {
        function AuditLog_1() {
            ...
            this.details = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _details_initializers, void 0));
            this.timestamp = (__runInitializers(this, _details_extraInitializers), __runInitializers(this, _timestamp_initializers, void 0));
    ...
    (function () {
        ...
        _user_decorators = [(0, typeorm_1.Column)()];
        _details_decorators = [(0, typeorm_1.Column)()];
        _timestamp_decorators = [(0, typeorm_1.CreateDateColumn)({ name: 'timestamp' })];
