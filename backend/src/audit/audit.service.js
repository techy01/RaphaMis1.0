...
var AuditService = function () {
    ...
    var AuditService = _classThis = /** @class */ (function () {
        ...
        AuditService_1.prototype.log = function (user, details) {
            return __awaiter(this, void 0, void 0, function () {
                var logEntry;
                return __generator(this, function (_a) {
                    logEntry = this.auditLogRepository.create({ user: user, details: details });
                    return [2 /*return*/, this.auditLogRepository.save(logEntry)];
                });
            });
        };
        AuditService_1.prototype.findRecent = function () {
