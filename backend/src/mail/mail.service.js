        ...
        MailService_1.prototype.sendPasswordResetEmail = function (email, token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    console.log("Sending password reset email to ".concat(email, " with token ").concat(token));
                    // Mock implementation
                    return [2 /*return*/, Promise.resolve()];
                });
            });
        };
        MailService_1.prototype.sendWelcomeEmail = function (email, name) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    console.log("Sending welcome email to ".concat(name, " <").concat(email, ">"));
                    // Mock implementation
                    return [2 /*return*/, Promise.resolve()];
                });
            });
