...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var logger, app, usersService, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger = new common_1.Logger('SeedSuperadminScript');
                ...
                case 2:
                    ...
                    return [4 /*yield*/, usersService.seedSuperAdmin()];
                case 3:
                    _a.sent();
                    logger.log('================================================================');
                ...
                case 4:
                    error_1 = _a.sent();
                    logger.error('Error during superadmin seeding:', error_1);
                    process.exit(1);
                    return [3 /*break*/, 7];
