...
exports.TenantsController = exports.UpdateTenantDto = void 0;
...
var UpdateTenantDto = function () {
    ...
    return _a = /** @class */ (function () {
            function UpdateTenantDto() {
                ...
                this.status = (__runInitializers(this, _subscriptionPlan_extraInitializers), __runInitializers(this, _status_initializers, void 0));
        ...
        (function () {
            ...
            _phone_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsPhoneNumber)('KE')];
            _address_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _subscriptionPlan_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsIn)(['Basic', 'Pro', 'Enterprise'])];
            _status_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)([tenant_entity_1.TenantStatus.Active, tenant_entity_1.TenantStatus.Inactive, tenant_entity_1.TenantStatus.Suspended])];
...
var TenantsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(user_entity_1.UserRoleEnum.Superadmin), (0, common_1.Controller)('tenants')];
    ...
    var TenantsController = _classThis = /** @class */ (function () {
        function TenantsController_1(tenantsService) {
            this.tenantsService = (__runInitializers(this, _instanceExtraInitializers), tenantsService);
        }
        TenantsController_1.prototype.create = function (createTenantDto) {
            return this.tenantsService.create(createTenantDto);
        };
        TenantsController_1.prototype.findAll = function () {
            return this.tenantsService.findAll();
        };
        TenantsController_1.prototype.findOne = function (id) {
            return this.tenantsService.findOne(id);
        };
        TenantsController_1.prototype.update = function (id, updateTenantDto) {
            return this.tenantsService.update(id, updateTenantDto);
        };
        TenantsController_1.prototype.remove = function (id) {
            return this.tenantsService.remove(id);
        };
        return TenantsController_1;
    }());
