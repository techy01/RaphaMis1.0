...
var Tenant = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('tenants')];
    ...
    var Tenant = _classThis = /** @class */ (function () {
        function Tenant_1() {
            ...
            this.subscriptionPlan = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _subscriptionPlan_initializers, void 0));
            this.createdAt = (__runInitializers(this, _subscriptionPlan_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
            this.updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, void 0));
            this.invoices = (__runInitializers(this, _updatedAt_extraInitializers), __runInitializers(this, _invoices_initializers, void 0));
    ...
    (function () {
        ...
        _subscriptionPlan_decorators = [(0, typeorm_1.Column)({ name: 'subscription_plan' })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)({ name: 'created_at' })];
        _updatedAt_decorators = [(0, typeorm_1.UpdateDateColumn)({ name: 'updated_at' })];
        _invoices_decorators = [(0, typeorm_1.OneToMany)(function () { return invoice_entity_1.Invoice; }, function (invoice) { return invoice.tenant; })];
