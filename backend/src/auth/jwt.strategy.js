    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService) {
            var _this = _super.call(this, {
                ...
                secretOrKey: configService.get('JWT_SECRET', 'a-very-strong-and-long-secret-key-for-jwt'),
            }) || this;
        ...
        JwtStrategy_1.prototype.validate = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, { id: payload.sub, name: payload.username, role: payload.role, email: payload.email }];
                });
            });
        };
